...
// RRC Input Port
GPIO_PIN(RRC_Input1, GpioInputPU, B, 4);
GPIO_PIN(RRC_Input2, GpioInputPU, B, 5);
GPIO_PIN(RRC_Input3, GpioInputPU, B, 6);
GPIO_PIN(RRC_Input4, GpioInputPU, B, 7);
GPIO_PIN(RRC_Input5, GpioInputPU, B, 10);
GPIO_PIN(RRC_Input6, GpioInputPU, B, 11);
GPIO_PIN(RRC_Input7, GpioInputPU, B, 12);
GPIO_PIN(RRC_Input8, GpioInputPU, B, 13);

typedef GpioInitializer<LED_BLUE_RAW_Pin, ADJ_BUTTON_Pin,
		LedDriver_BLANK_Pin, LedDriver_XLAT_Pin,
		RRC_Input1_Pin, RRC_Input2_Pin, RRC_Input3_Pin, RRC_Input4_Pin,
		RRC_Input5_Pin, RRC_Input6_Pin, RRC_Input7_Pin, RRC_Input8_Pin>
	GpioInit;
